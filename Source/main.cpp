...
const String GetGenerationTime()
{
...
int WriteHeaders(const WString& srcdir = "Source/", const WString& filename = "ComponentSystem")
{
	...
	stream->WriteLine("// Generated on: " + GetGenerationTime() + "//");
	stream->WriteLine("//-----------------------------------------------------------------------");
	stream->WriteLine("");
	...
	stream2->WriteLine("// Generated on: " + GetGenerationTime() + "//");
	stream2->WriteLine("//-----------------------------------------------------------------------");
	stream2->WriteLine("");
...
const bool IsHelpFlagSet(nlohmann::json& j3)
{
	return (!j3["help"].is_null() && j3["help"].is_boolean());
}
...
int main(int argc, const char* argv[])
{
	...
	if (IsHelpFlagSet(args)) return DisplayHelp();
